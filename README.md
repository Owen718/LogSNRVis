...
1. SD3 / FLUX training: \(\mathcal{N}(\mu = -2\log3, \sigma = 2)\)
...
| `sd3_flux_lambda_hist_verify.png` | Same as above but for SD3 / Flux distribution: \(\mu=-2\log3,\sigma=2\). | Confirms the SD3 training sampler shape. |
